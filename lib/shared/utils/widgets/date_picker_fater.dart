...
class DatePickerFaterWidget extends StatefulWidget {

  final String label;
  int? formfield;

  DatePickerFaterWidget({
    super.key,
    required this.label, 
    this.formfield,
  });
  ...
  @override
  State<DatePickerFaterWidget> createState() => _DatePickerFaterWidgetState();
}

class _DatePickerFaterWidgetState extends State<DatePickerFaterWidget> {
    ...
    if (picked != null && picked != selectedDate) {
      ...
      setState(() {
        ...
        if(widget.formfield == 1){
          controller.dataAtendimento = selectedDate;
