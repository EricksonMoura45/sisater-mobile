...
class Themes {
  ...
  static const Color vermelhoClaro = Color(0xffFFCCCC);
  static const Color vermelhoEscuro = Color(0xff631818);

  static const Color amareloTexto = Color(0xffCC9900);
  static const Color laranjaTexto = Color(0xffCC6633);
  static const Color vermelhoTexto = Color(0xffCC3333);
  static const Color verdeTextoMaior = Color(0xff006666);


  static const pretoPadrao = TextStyle(
    color: pretoTexto,
