...
class CadastrarIntegranteFamiliarPage extends StatefulWidget {
  const CadastrarIntegranteFamiliarPage({super.key});

  @override
  State<CadastrarIntegranteFamiliarPage> createState() => _CadastrarIntegranteFamiliarPageState();
}

class _CadastrarIntegranteFamiliarPageState extends State<CadastrarIntegranteFamiliarPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: formAppBarFamiliar(context, 'Cadastrar Familiar', false, ''),
      body: Padding(
      ...
      child: Row(
        ...
        children: [
          Observer(builder: (_){
            ...
            if(controller.statusPostFamilar == Status.AGUARDANDO){
              return CircularProgressIndicator(
                color: Colors.white,
              );
            }
            else if(controller.statusPostFamilar == Status.ERRO){
              return Text(
            'Cadastrar',
            style: TextStyle(
              fontSize: 18,
            ...
            else if(controller.statusPostFamilar == Status.CONCLUIDO){
              return Text(
            'Cadastrar',
            style: TextStyle(
              fontSize: 18,
      ...
      children: [
        buildInputField(
            ...
            DropdownButtonFormField<Escolaridade>(
              ...
              borderRadius: BorderRadius.circular(10),
               key: const ValueKey('escolaridadeeDropdown'),
               isExpanded: true,
