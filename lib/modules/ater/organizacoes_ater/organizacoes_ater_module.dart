...
import 'package:sisater_mobile/modules/ater/organizacoes_ater/pages/cadastrar_organizacao_ater_page.dart';
import 'package:sisater_mobile/modules/ater/organizacoes_ater/pages/cadastro_sucesso_organizacao_ater_page.dart';
import 'package:sisater_mobile/modules/ater/organizacoes_ater/pages/editar_organizacao_ater.dart';
import 'package:sisater_mobile/modules/ater/organizacoes_ater/pages/organizacoes_ater_page.dart';
import 'package:sisater_mobile/modules/ater/organizacoes_ater/pages/visualizar_organizacao_ater_page.dart';
...
class OrganizacoesAterModule extends Module{
  ...
  List<ModularRoute> get routes => [
        ...
        ChildRoute(
          ...
          child: (_, args) => const CadastrarOrganizacaoAterPage(),
        ...
        ChildRoute(
          '/visualizar_ater_organizacao',
          child: (_, args) => const VisualizarOrganizacaoAterPage(),
          transition: TransitionType.leftToRight,
        ),
  ];   
