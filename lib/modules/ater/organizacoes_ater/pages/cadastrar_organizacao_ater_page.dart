...
class CadastrarOrganizacaoAterPage extends StatefulWidget {
  const CadastrarOrganizacaoAterPage({super.key});

  @override
  State<CadastrarOrganizacaoAterPage> createState() => _CadastrarOrganizacaoAterPageState();
}

class _CadastrarOrganizacaoAterPageState extends State<CadastrarOrganizacaoAterPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: formAppBar(context, 'Cadastrar Organização', false, ''),
      body: Observer(
        builder: (_) {
  ...
  String _getStepTitle(int step) {
    switch (step) {
      case 0:
        return 'Informações Organizacionais';
      case 1:
  ...
  Widget _getStepContent(int step) {
    switch (step) {
      case 0:
        return formularioOrganizacionais();
      case 1:
      ...
      children: [
        ...
        DropdownButtonFormField<UF>(
          ...
          Observer(builder: (_){
            ...
            if(controller.statusCarregaMunicipios == Status.CONCLUIDO){
              return Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                   Text('Município*',
