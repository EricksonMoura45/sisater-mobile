...
class BeneficiarioVisualizarProntuarioPage extends StatefulWidget {
  const BeneficiarioVisualizarProntuarioPage({super.key});

  @override
  State<BeneficiarioVisualizarProntuarioPage> createState() => _BeneficiarioVisualizarProntuarioPageState();
}

class _BeneficiarioVisualizarProntuarioPageState extends State<BeneficiarioVisualizarProntuarioPage> {
  String? _pdfPath;
  String? _error;
  String? fileName;
  ...
  void _loadPdfFromArguments() {
    try {
      ...
      if (args != null) {
        ...
        beneficiaryName = args['beneficiaryName'] as String?;
      ...
      try {
        ...
        if (file.existsSync()) {
          await Share.shareXFiles(
            [XFile(_pdfPath!)],
            text: 'Meu Prontuário - ${fileName ?? 'prontuario.pdf'}',
          );
        } else {
                    ...
                    Expanded(
                      child: PDFView(
                        ...
                        onPageError: (page, error) {
                          // Tratar erro de página silenciosamente
                        },
