...
class FaterCard extends StatelessWidget {

   BeneficiarioFaterList beneficiarioFaterList;

  FaterCard({
    super.key,
    required this.beneficiarioFaterList,
  });
  ...
  Widget build(BuildContext context) {
    ...
    String nomeMunicipio = controller.municipiosSelecionaveis.firstWhere(
      (element) => element.code == beneficiarioFaterList.cityCode,
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Text('Beneficiário Fater', style: TextStyle(color: Colors.white),),
                      )),
                      Row(
                        children: [
                          GestureDetector(
                            onTap: () async {
                             ...
                             Modular.to.pushNamed('editar_fater', arguments: beneficiarioFaterList);   
                      ...
                      GestureDetector(
                        onTap: () async{
                          ...
                          exibirAlertDialog(context, beneficiarioFaterList);
                  ...
                  SizedBox(height: 10,),
                Flexible(
                  child: Text(beneficiarioFaterList.communities ?? 'Nome indisponível',
                  maxLines: 1,
                    ...
                    children: [
                      Flexible(
                        child: Column(
                          ...
                          children: [
                            Text('Código'),
                            Text(beneficiarioFaterList.code.toString() ?? 'Cpf indisponível', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
                          ],
                        ),
                      ),
                      ...
                      Flexible(
                        child: Column(
                          children: [
                            Text('Ano'),
                            Text(beneficiarioFaterList.year.toString() ?? '---', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
                          ],
                        ),
                      ),
                    ],
                      ...
                      Flexible(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(nomeMunicipio ?? '', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
                          ],
                        ),
                      ),
                      //SizedBox(width: MediaQuery.of(context).size.width / 10,),
                      ...
                      Flexible(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(beneficiarioFaterList.action_date ?? 'Cpf indisponível', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
                          ],
                        ),
                      ),
                    ],
  ...
  void exibirAlertDialog(BuildContext context, BeneficiarioFaterList beneficiarioAter) {
  BeneficiarioFaterController controller = Modular.get();
              ...
              Padding(
                ...
                child: MaterialButton(
                  ...
                  onPressed: () async {
                    ...
                    await controller.deleteBeneficiarioFater(beneficiarioAter.id);
