...
class CadastrarComunidadePage extends StatefulWidget {
  const CadastrarComunidadePage({super.key});

  @override
  State<CadastrarComunidadePage> createState() => _CadastrarComunidadePageState();
}

class _CadastrarComunidadePageState extends State<CadastrarComunidadePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: formAppBar(context, 'Cadastrar Comunidade', false, ''),
      body: Padding(
